...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
     ...
     <a href="stmessage"><button style="background-color:#e4b461 !important; color:#fff !important; font-size:1rem" class="d-sm-inline-block btn btn-sm shadow-sm mx-4 px-1 py-2" id="printNone"><i style="color:#fff !important;"
                                class="fas fa-mail-bulk fa-sm text-white-50"></i> View all Mails</button></a>
     </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="p-5">
                                                ...
                                                ?>
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
     <h1 style="color:#000 !important;" class="h5 ml-2 mb-4 text-dark-800">From: <?php echo $mail_sender?></h1>
